...
stroke_mortality_1719 <- read.csv("shinyApp/data/Stroke/Stroke_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County___2017-2019.csv")
...
stroke_mortality_1517 <- read.csv("shinyApp/data/Stroke/Stroke_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County___2015-2017.csv")
...
stroke_mortality_1315 <- read.csv("shinyApp/data/Stroke/Stroke_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County (2).csv")
...
hd_mortality_1719 <- read.csv("shinyApp/data/Heart Disease/Heart_Disease_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County___2017-2019.csv")
...
hd_mortality_1517 <- read.csv("shinyApp/data/Heart Disease/Heart_Disease_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County___2015-2017.csv")
...
hd_mortality_1315 <- read.csv("shinyApp/data/Heart Disease/Heart_Disease_Mortality_Data_Among_US_Adults__35___by_State_Territory_and_County.csv")
