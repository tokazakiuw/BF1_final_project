    ...
    mainPanel(
      tabsetPanel(type = "tab",
                  ...
                  tabPanel("Map",
                           ...
                           strong(textOutput("label1")),
                           plotlyOutput("map"), br(),
                           strong(textOutput("label2")),
                           leafletOutput("lmap")
                           ),
                  ...
                  tabPanel("Insights",
                          ...
                          textOutput('insights_time'),
                           plotOutput("lineplot"),
                          textOutput("lineplot.desc"),
                          plotOutput("top.counties"),
                          textOutput("findings.counties")),
                  navbarMenu("About Us",
